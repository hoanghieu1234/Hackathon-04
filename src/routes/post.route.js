...
const postJson = path.join(__dirname, "../user-post-api/posts.json");

route
  .route("/")
  .get((req, res) => {
    fs.readFile(postJson, (err, data) => {
      if (err) {
  ...
  .post((req, res) => {
    fs.readFile(postJson, (err, data) => {
      ...
      fs.writeFile(postJson, JSON.stringify(dataConvert), () => {
...
route
  ...
  .put((req, res) => {
    ...
    fs.readFile(postJson, (err, data) => {
      ...
      fs.writeFile(postJson, JSON.stringify(convertData), () => {
  ...
  .delete((req, res) => {
    ...
    fs.readFile(postJson, (err, data) => {
      ...
      fs.writeFileSync(postJson, JSON.stringify(filterData));
